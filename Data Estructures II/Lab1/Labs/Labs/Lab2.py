...
def RecorridoPreorden(nodo, resultado=None):
    """
    ...
    if nodo is not None:
        resultado.append(nodo.info)  # Visitar la raíz
        RecorridoPreorden(nodo.izq, resultado)  # Recorrer subárbol izquierdo
        RecorridoPreorden(nodo.der, resultado)  # Recorrer subárbol derecho
    
    return resultado

def RecorridoInorden(nodo, resultado=None):
    """
    ...
    if nodo is not None:
        RecorridoInorden(nodo.izq, resultado)  # Recorrer subárbol izquierdo
        resultado.append(nodo.info)  # Visitar la raíz
        RecorridoInorden(nodo.der, resultado)  # Recorrer subárbol derecho
    
    return resultado

def RecorridoPostorden(nodo, resultado=None):
    """
    ...
    if nodo is not None:
        RecorridoPostorden(nodo.izq, resultado)  # Recorrer subárbol izquierdo
        RecorridoPostorden(nodo.der, resultado)  # Recorrer subárbol derecho
        resultado.append(nodo.info)  # Visitar la raíz
...
def main():
    ...
    print("Laboratorio No.2: Recorridos de árboles binarios")
    print("Grupo: 1IL-126")
    ...
    preorden = RecorridoPreorden(raiz)
    print(f"\nRecorrido en Preorden (Raíz -> Izq -> Der):")
    print(f"Secuencia: {' -> '.join(map(str, preorden))}")
    
    # Recorrido en Inorden
    inorden = RecorridoInorden(raiz)
    print(f"\nRecorrido en Inorden (Izq -> Raíz -> Der):")
    print(f"Secuencia: {' -> '.join(map(str, inorden))}")
    
    # Recorrido en Postorden
    postorden = RecorridoPostorden(raiz)
    print(f"\nRecorrido en Postorden (Izq -> Der -> Raíz):")
    print(f"Secuencia: {' -> '.join(map(str, postorden))}")
